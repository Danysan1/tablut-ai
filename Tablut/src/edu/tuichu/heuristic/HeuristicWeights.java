...
public class HeuristicWeights extends HashMap<FactorType, Integer> {
	...
	private HeuristicWeights() {
		...
		this.put(FactorType.EATEN_WHITE_PAWNS, -200);
		this.put(FactorType.EATEN_BLACK_PAWNS, 200);
		this.put(FactorType.DISTANCE_TO_WIN, -100);
		this.put(FactorType.WHITE_PAWNS_IN_WIN_CELLS, -300);
		this.put(FactorType.BLACK_PAWNS_IN_WIN_CELLS, -300);
		this.put(FactorType.WHITE_PAWNS_ADJACENT_TO_KING, 100);
		this.put(FactorType.BLACK_PAWNS_ADJACENT_TO_KING, -400);
